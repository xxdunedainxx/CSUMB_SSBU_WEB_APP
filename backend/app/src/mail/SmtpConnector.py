...
from src.mail.MailFormatter import MailFormatter, MailTypes, DeploymentFormatter, FeedbackEmail, VerifyEmailFormatter
...
%s
  ...
  def send_html_email(self, emailData: dict , toEmail: Any, subject: str, emailBody: str, formatter: str):
    ...
    if formatter == MailTypes.DEPLOYMENT_EMAIL:
      mailFormatter: MailFormatter = DeploymentFormatter(emailData)
    elif formatter == MailTypes.VERIFY:
      mailFormatter: MailFormatter = VerifyEmailFormatter(emailData)
    elif formatter == MailTypes.FEEDBACK:
      mailFormatter: MailFormatter = FeedbackEmail(emailData)
    else:
