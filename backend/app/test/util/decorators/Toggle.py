"""
  ...
  Date: 2/2/26
  Synopsis: Test toggles class. This class contains decorats that can be applied to tests, in order to ensure they are enabled or disabled
            Disabled tests will be skipped.
            The testing framework will also grab metrics on tests that passed & failed, and can be used to export a test report at the end of the test run.
"""
